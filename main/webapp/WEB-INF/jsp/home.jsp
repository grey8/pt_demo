...
<script type="text/javascript">
    ...
    function uploadFile() {
        filename = document.getElementsById("changeHeadPic").value;
        $.ajaxFileUpload({
            url: "<%=request.getContextPath()%>/userAction/uploadHeadPic",
            secureuri: false,
            fileElementId: 'changeHeadPic',
            dateType: 'json',
...
<div class="am-model am-model-prompt" tabindex="-1" id="my-prompt">
            ...
            <div class="user-box am-hide-sm-only">
                <div class="user-img">
                    ...
                    <div class="user-status offline">
                        <i class="am-icon-circle-o"aria-hidden="true"></i>
                    </div>
                </div>
